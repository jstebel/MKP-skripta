...
for i = 1:length(n)
  ...
  % VYBER ULOHY
%  [x,u,e] = mkp1d_laplace_dirBC_3_func(L,n(i));
%  [x,u,e] = mkp1d_laplace_dirBC_4_func(L,n(i));
%  [x,u,e] = mkp1d_laplace_BC_func(L,n(i));
  
%  [x,u,e] = mkp1d_laplace_BC_local_func(L,n(i));
%  [x,u,e] = mkp1d_laplace_BC_local_rhs_func(L,n(i));

  [x,u,e] = mkp1d_laplace_BC_ref_func(L,n(i));
